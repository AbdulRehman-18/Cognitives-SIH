        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[16px]">
          <section className="lg:col-span-7 rounded-[16px] border border-[color:var(--color-border-resting)] bg-[color:var(--color-surface-1)] p-[18px]">
            ...
            <div className="mt-[12px] grid grid-cols-1 sm:grid-cols-2 gap-[8px]">
              {depts.map((d) => (
                <div key={d.id} className="rounded-[12px] border border-[color:var(--color-border-resting)] bg-[color:var(--color-surface-1)] px-[12px] py-[11px] flex items-center justify-between">
                  <span className="text-[13px] font-medium truncate pr-[8px]">{d.name}</span>
                  <span className="num text-[11px] tabular-mono font-semibold shrink-0 border rounded-full px-[8px] py-[3px] bg-[color:var(--color-surface-1)]">{d._count.users}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="lg:col-span-5 rounded-[16px] border border-[color:var(--color-border-resting)] bg-[color:var(--color-surface-1)] p-[18px] flex flex-col gap-[12px]">
            <div>
              ...
              <div className="mt-[12px] grid grid-cols-3 gap-[8px]">
                <div className="rounded-[12px] bg-[color:var(--color-ink)] text-[color:var(--color-canvas)] p-[12px] text-center"><p className="num text-[22px] font-[700] leading-none">{gaps}</p><p className="text-[11px] opacity-70 mt-[4px]">total gaps</p></div>
                ...
                <div className="rounded-[12px] bg-[color:var(--color-surface-1)] border border-[color:var(--color-border-resting)] p-[12px] text-center"><p className="num text-[22px] font-[700] leading-none">{learnerCount + trainerCount}</p><p className="text-[11px] text-muted-foreground">people</p></div>
              </div>
            </div>
            <div className="rounded-[12px] bg-[color:var(--color-surface-1)] border border-[color:var(--color-border-resting)] p-[12px]">
