...
export function tutorRefusalMessage(language: TutorLanguage = "en"): string {
  if (language === "hi") {
    return (
      "यह प्रश्न SkillForge पर उपलब्ध प्रशिक्षण सामग्री के दायरे से बाहर है, इसलिए मैं अनुमान से उत्तर नहीं दूँगा। " +
      "आप अपने नोट्स अपलोड कर सकते हैं, या अपने प्रशिक्षक से संबंधित दस्तावेज़ जोड़ने का अनुरोध कर सकते हैं।"
    );
  }
  return (
